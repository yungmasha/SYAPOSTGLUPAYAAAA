...
type TipsSliderProps = {
  embedded?: boolean
}

export default function TipsSlider({ embedded = false }: TipsSliderProps) {
  ...
  return (
    <section
      className={`tips-slider${embedded ? ' tips-slider--embedded' : ''}`}
      aria-roledescription="carousel"
      aria-label="Полезные советы"
    >
      {!embedded && <h2 className="tips-slider__heading">Полезно знать</h2>}
